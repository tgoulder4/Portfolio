...
export const Divider = ({ direction, mode, className, ...props }: dividerProps) => {
  if (mode == "thin") return <div {...props} className={`${className} border-[1px] border-[#dddddd] ${direction == "horizontal" ? "" : "h-full "}`} />;
            ...
            <div className="LowerContForLeftFiller position-relative">
              ...
              <section id="yellow3" className="">
                <div id="contentS2" className="cyan cyan2 ">
                  ...
                  <div id="projectArea"
                    className="relative purple4 px-[var(--mobileStandardMargin)] w-[70vw] sm:px-[50px] flex flex-column"
                  >
