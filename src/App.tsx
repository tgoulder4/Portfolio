...
export const Divider = ({ direction, mode, className, ...props }: dividerProps) => {
  if (mode == "thin") return <div {...props} className={`${className} border-[1px] border-[#dddddd]`} />;
    ...
    id="lFiller1"
    className={`${className} filler absolute hidden sm:block left-0 w-7vw md:w-[12.5vw] bg-[rgb(0_0_0_0.8)] goesToLeft h-[calc(1006px-var(--CYANMARGINWIDTH))]`}
  />
}
function App() {
  return (
